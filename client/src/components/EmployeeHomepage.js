      ...
      <div className="homepage">
        <div className="welcome">
          <div className="welcome-text">
            <h2>
              Professional Construction Services with Quality and Integrity
            </h2>
            <p>
              Residential Construction: Custom homes, renovations, and
              additions.
              <br />
            ...
            <p>
              ...
              <br />
              <strong>Quality Assurance:</strong> Commitment to high standards
              and meticulous attention to detail.
              <br />
              <strong>Timely Completion:</strong> Proven track record of
              completing projects on time and within budget.
              <br />
              <strong>Customer Focused:</strong> Personalized services tailored
